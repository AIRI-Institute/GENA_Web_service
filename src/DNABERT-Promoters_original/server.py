...
def save_annotations_files(dna_seq_names, req_path, counter_for_dna_seq_names) -> Dict:
    ...
    for j, seq_name in enumerate(dna_seq_names):
        ...
        list_of_bed_files.append(f"/generated/dnabert-promoters-original{req_path}/result_{seq_name}.bed")

    bed_dict = {"bed": list_of_bed_files, "fasta_file":f"/generated/dnabert-promoters-original{req_path}/dna.fa", "fai_file":f"/generated/dnabert-promoters-original{req_path}/dna.fa.fai"}
