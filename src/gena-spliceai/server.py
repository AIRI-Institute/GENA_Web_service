...
def save_annotations_files(dna_seq_names, req_path, all_preds_acceptors, all_preds_donors, all_tokenized_sequences, tokenizer):
    ...
    for j, seq_name in enumerate(dna_seq_names):
        ...
        with open(req_path + f'donors_{seq_name}.bed', 'w', encoding='utf-8') as fd: # need / before results...
            with open(req_path + f'acceptors_{seq_name}.bed', 'w', encoding='utf-8') as fa: # need / before results...
